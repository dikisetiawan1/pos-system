...
<html>
<head>
  <title>Export Data Produk Stok</title>
...
<div class="container">
			<h2 class="text-center">Data Produk Stok</h2>
        ...
        <table id="export" class="table table-striped">
                ...
                while ($item = mysqli_fetch_assoc($result)) {
                  ...
                  <a href="<?php echo BASE_URL . "index.php?&module=productStock&action=list"; ?>">Kembali</a>
				          </div>
                </div>
<script>
