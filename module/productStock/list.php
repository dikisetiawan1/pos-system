   ...
   <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Product Stock</h3></div>
              <div class="col-sm-6">
                ...
                while ($item = mysqli_fetch_assoc($result)) {
                  echo "
                      <tr>
                        ...
                        <td>$item[stok]</td>
                        <td> <a href='" . BASE_URL . "index.php?&module=productStock&action=formadd&id_produk=$item[id_produk]' type='button' class='btn btn-warning' ><i class='fas fa-plus'></i></a>  
                        <a href='" . BASE_URL . "index.php?&module=productStock&action=formmin&id_produk=$item[id_produk]' type='button' class='btn btn-danger' ><i class='fas fa-minus'></i></a>  </td>
                      </tr>";
                      $no++;
                    };
                   }else{
